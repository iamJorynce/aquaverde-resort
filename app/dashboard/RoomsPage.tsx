          ...
          {filteredRooms.length === 0 ? (
            ...
            <div key={r.id} className="bg-white border border-gray-100 rounded-xl p-3">
              ...
              <select
                ...
                disabled={!canManage}
                className={`w-full text-xs px-2 py-1 rounded-full font-medium border-0 ${statusColor[r.status] ?? 'bg-gray-100 text-gray-600'} disabled:opacity-60 disabled:cursor-not-allowed`}
              >
