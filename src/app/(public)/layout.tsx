      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-blue-700 rounded-lg flex items-center justify-center text-white font-bold text-sm">SE</div>
            <span className="font-semibold text-gray-800">Sea Eagle Beach Resort</span>
          </Link>
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-7 h-7 bg-blue-700 rounded-lg flex items-center justify-center text-white font-bold text-xs">SE</div>
              <span className="text-white font-semibold">Sea Eagle Beach Resort</span>
            </div>
            <p className="text-sm leading-relaxed">
              Your perfect beachside getaway in Pindasan, Mabini, Davao de Oro. Experience the beauty of nature with world-class hospitality.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <div>📍 Pindasan, Mabini, Davao de Oro, PH</div>
              <div>📞 +63 912 345 6789</div>
              <div>✉️ info@seaeaglebeachresort.ph</div>
              <div>🕐 Open 24/7</div>
            </div>
          </div>
        </div>
        <div className="max-w-6xl mx-auto px-4 mt-8 pt-8 border-t border-gray-800 text-sm text-center">
          © {new Date().getFullYear()} Sea Eagle Beach Resort. All rights reserved.
        </div>
      </footer>
    </div>
  )
